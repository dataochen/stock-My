...
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('2', 'submit', 'https://jywg.18.cn/Trade/SubmitTradeV2?validatekey=${validatekey}', '1', '提交委托');
...
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('15', 'cr_get_rzrq_asserts', 'https://jywg.18.cn/MarginSearch/GetRzrqAssets?validatekey=${validatekey}', '1', '信用我的资产');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('16', 'cr_query_collateral', 'https://jywg.18.cn/MarginSearch/QueryCollateral?validatekey=${validatekey}', '1', '信用我的持仓');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('17', 'cr_submit', 'https://jywg.18.cn/MarginTrade/SubmitTradeV2?validatekey=${validatekey}', '1', '信用提交委托');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('18', 'cr_revoke', 'https://jywg.18.cn/MarginTrade/RevokeOrders?validatekey=${validatekey}', '1', '信用撤单');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('19', 'cr_get_orders_data', 'https://jywg.18.cn/MarginSearch/GetOrdersData?validatekey=${validatekey}', '1', '信用当日委托');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('20', 'cr_get_deal_data', 'https://jywg.18.cn/MarginSearch/GetDealData?validatekey=${validatekey}', '1', '信用当日成交');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('21', 'cr_get_his_orders_data', 'https://jywg.18.cn/MarginSearch/GetHisOrdersData?validatekey=${validatekey}', '1', '信用历史委托');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('22', 'cr_get_his_deal_data', 'https://jywg.18.cn/MarginSearch/GetHisDealData?validatekey=${validatekey}', '1', '信用历史成交');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('23', 'cr_get_can_buy_new_stock_list_v3', 'https://jywg.18.cn/MarginTrade/GetCanBuyNewStockListV3?validatekey=${validatekey}', '1', '信用查询可申购新股列表');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('24', 'cr_get_convertible_bond_list_v2', 'https://jywg.18.cn/MarginTrade/GetConvertibleBondListV2?validatekey=${validatekey}', '1', '信用查询可申购新债列表');
INSERT INTO `trade_method` (`id`, `name`, `url`, `state`, `description`) VALUES ('25', 'cr_submit_bat_trade_v2', 'https://jywg.18.cn/MarginTrade/SubmitBatTradeV2?validatekey=${validatekey}', '1', '信用批量申购');
...
INSERT INTO `trade_rule` (`id`, `stock_code`, `strategy_id`, `user_id`, `type`, `value`, `volume`, `open_price`, `highest_price`, `lowest_price`, `state`, `description`) VALUES ('2', '300059', '2', '1', '1', '1.000000', '300', '31', '40.000000', '30.000000', '0', '');

INSERT INTO `trade_strategy` (`id`, `name`, `bean_name`, `state`) VALUES ('1', 'gridStrategy', 'gridStrategyHandler', '1');
INSERT INTO `trade_strategy` (`id`, `name`, `bean_name`, `state`) VALUES ('2', 'crGridStrategy', 'gridStrategyHandler', '1');